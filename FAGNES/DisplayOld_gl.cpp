...
void processarEntrada(GLFWwindow* janela); // Processamento de eventos de entrada.
...
unsigned int criarGrid() {
	...
	for (int linha = 0; linha < PIXELS_ALTURA; linha++) {
		for (int coluna = 0; coluna < PIXELS_LARGURA; coluna++) {
			distanciaX = distanciaPadrao * coluna;
			distanciaY = distanciaPadrao * linha;

			vertices[indice++] = 1.0f - distanciaX;
			vertices[indice++] = 1.0f - distanciaY;
			vertices[indice++] = 0.0f;

			vertices[indice++] = 1.0f - distanciaX;
			vertices[indice++] = 1.0f - distanciaPadrao - distanciaY;
			vertices[indice++] = 0.0f;

			vertices[indice++] = 1.0f - distanciaPadrao - distanciaX;
			vertices[indice++] = 1.0f - distanciaPadrao - distanciaY;
			vertices[indice++] = 0.0f;
